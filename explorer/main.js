...
var prompt_Jeremy =     "I'm unsure if my conclusion is accurate, but after reviewing the documents for almost an hour here is what I think is going on: <br/> <br/> "+
						"I tried working backward from May 2009 to find links of disease spread to illegal arms dealing. Unfortunately, none of these documents outwrite discuss 'disease,' but there is a discussion between a Russian (Dombroski) and the Nigerians (Dr. George) about a 'Health issue' that might prevent them from meeting in Paris.<br>"+
						"The Russian also seems to be talking with a Kenyan man (Thabiti Otieno) and his partner (Nahid Owiti) about the delivery of some jewels (code word for arms?) on the M/V Tanya (ship from Ukraine) in April 2009. Oddly, by May we have records of the kenyans' obituaries. <br>"+
						"I don't know if any Syrians are actually involved with arms dealing since it sounds like they are just discussing the need for textbooks for a new school. Oddly they do travel to Dubai to meet with The Professor (a textbook salesman) but this could be unrelated. I feel there are many more countries that require review but our Intelligence division may be on to something here. "
...
var instructions_Jeremy = "A infectious disease started a pandemic in 2009. Analysts believe that the disease started in <b>Nigeria</b> in February of 2009, and then strangly spread to Kenya, Syria, Lebanon, Pakistan, Yemen, Saudi Arabia, Iran, Venezuela, and Columbia fairly quickly. Cases of sickness and death later peaked in May 2009. The intelligence division wants you to investigate whether there is a connection between <b>illegal arms dealing</b> and the how the <b>disease spread</b>.<br>" +
						"The following documents relate to arms dealing between countries around the world prior to the outbreak. Describe the associations and interactions among the players in the weapons dealings.<br><br>"+
	...
	console.log("DOCUMENT READY");
		...
		var createNote = function (noteHtml, setWidth = 200) {
			...
			if (noteHtml === 'instructions'){
				...
				output += '<div id="' + noteId + '" class="note-set doc-content" document_id="noteSolution" title="Leave a Summary for Analyst C " contenteditable="true"></div> </div>'
